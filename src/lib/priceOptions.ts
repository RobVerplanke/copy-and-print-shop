const basePriceOptionsFlyers: string[] = [
  '50',
  '100',
  '150',
  '200',
...
const lowPriceOptionsShort: string[] = ['50', '100', '250'];
const paperSizes: string[] = ['A2', 'B2', 'A1', 'B1', 'A0'];
const canvasSizes: string[] = ['A3', 'A2', 'B2', 'A1', 'B1', 'A0'];
const pages: string[] = ['1-5', '6-10'];
...
const splitPriceOptionsShortLowest: string[] = ['1-10', '11-50', '51-100'];
